  ...
  return (
    <div style={{ margin: 20 }}>
      ...
      <p>
        ...
        <a href="https://www.voyagenepal.tech/">
          https://www.voyagenepal.tech/
        </a>
      </p>
      <p>
      ...
      <p>
        ...
        <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_">
          where I can change settings for dissabling or deleting local shared
          objects.
        </a>
      </p>
      <p>
      ...
      <p>
        <b>Purpose:</b> These Cookies identify if users have accepted the use of
      ...
      <p>
        <b>Purpose:</b> These Cookies allow us to remember choices You make when
      ...
      <p>
        <strong>To contact You: </strong>to manage Your registration as a user
      ...
      <p><strong>By email: </strong><a href="mailto:email.kustore@gmail.com">email.kustore@gmail.com</a></p>
      <p><strong>By phone number: +977-9862230459</strong></p>
    </div>
  );
}
